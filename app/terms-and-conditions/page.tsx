            ...
            >
                ...
                <div className="z-10 w-full max-w-7xl !mx-auto !px-6 grid grid-cols-2 gap-3 md:gap-16 items-center">
                    ...
                    <div className="flex flex-col items-start">
                        ...
                        <h1 ref={titleRef} className="text-4xl md:text-5xl lg:text-6xl font-black text-white !my-2 md:!my-4 leading-[1.15] tracking-tight">
                            Terms & <span className="text-[#2197A1]">Conditions</span>
                        </h1>
                    ...
                    <div ref={imageRef} className="relative group">
                        ...
                        <div className="relative bg-white/10 backdrop-blur-md rounded-[2.5rem] p-4 border-4 border-white/20 shadow-2xl transform lg:rotate-2 hover:rotate-0 transition-all duration-700 overflow-hidden">
                            <img
                                src="/images/terms-conditions-hero.png"
                ...
                <div className="max-w-7xl !mx-auto relative">
                    ...
                    <div className="relative z-10 !space-y-10">
                        ...
                        <div>
                            ...
                            <p className="text-lg text-[#2A2A2A]/70 leading-relaxed font-medium">
                                You agree to use this website for lawful purposes only. You must not use this website in any way that may cause damage to the website or affect its availability.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-lg text-[#2A2A2A]/70 leading-relaxed font-medium">
                                Prodbiz Solutions provides digital services including software development, digital marketing, and creative media production. All services are subject to project agreements and scope defined with clients.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-lg text-[#2A2A2A]/70 leading-relaxed font-medium mb-6">
                                All content on this website, including text, graphics, logos, and design, is the property of Prodbiz Solutions and is protected by applicable copyright laws.
                                You may not reproduce, distribute, or use any content without permission.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-lg text-[#2A2A2A]/70 leading-relaxed font-medium">
                                Prodbiz Solutions will not be held liable for any direct or indirect damages arising from the use of this website or services.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-lg text-[#2A2A2A]/70 leading-relaxed font-medium">
                                Any information submitted through forms must be accurate and truthful. Misuse of forms or false information may result in restricted access.
                            </p>
                        </div>
                        ...
                        <div>
                            <h2 className="!text-2xl font-bold text-[#2A2A2A] mb-6 flex items-center gap-3">
                                <span className="w-8 h-8 rounded-lg bg-[#2197A1]/10 text-[#2197A1] flex items-center justify-center text-sm font-black">08</span>
                                Changes to Terms
                            </h2>
                            <p className="text-lg text-[#2A2A2A]/70 leading-relaxed font-medium">
                                We may update these Terms & Conditions at any time without prior notice. Users are encouraged to review this page periodically.
                            </p>
                        </div>
