...
const whyChooseUsData = [
    {
        ...
        desc: "We create professional designs that make your business look attractive, trustworthy, and stand out.",
        icon: <Palette size={32} />
    },
    {
        title: "Based on Needs",
        desc: "We create custom designs based on your business, audience, and goals to match your brand perfectly.",
        icon: <Target size={32} />
    },
    {
        title: "Modern & Attractive",
        desc: "We create clean, modern designs like logos, posters, and social media creatives that grab attention.",
        icon: <Sparkles size={32} />
    },
    {
        title: "Fast Delivery",
        desc: "We deliver your designs on time and support you even after delivery whenever you need changes.",
        icon: <Zap size={32} />
    }
];
...
const designServices = [
    { title: "Logo Design", desc: "Unique and professional logos representing your brand.", icon: <Target size={32} /> },
    { title: "Posters & Flyers", desc: "Attractive designs to promote your business effectively.", icon: <ImageIcon size={32} /> },
    { title: "Social Media", desc: "Engaging creatives for Instagram, Facebook, and more.", icon: <Instagram size={32} /> },
    { title: "Menu Design", desc: "Clean and attractive menu cards for hospitality.", icon: <UtensilsCrossed size={32} /> },
    { title: "Business Cards", desc: "Professional corporate identity and brochures.", icon: <IdCard size={32} /> },
];
...
export default function BrandingDesigningPage() {
    ...
    const titleText = "Branding & Design Services";
    const paraText = "We create simple and professional designs to help your business look good and attract more customers.";
    const smallLineText = "From logos to posters and social media creatives, we create everything your business needs.";
    ...
    useEffect(() => {
        ...
        // --- Hero Entrance Sequence (Digital Marketing Style) ---
        if (titleRef.current && paraRef.current && smallLineRef.current && buttonsRef.current) {
            ...
            // Title Characters Slide from Left
            tl.fromTo(
                chars,
                { x: -40, opacity: 0 },
                {
            ...
            // Buttons Animation Slide from Bottom
            tl.fromTo(
                buttons,
                { y: 40, opacity: 0 },
                {
        ...
        if (portfolioSectionRef.current && portfolioHeaderRef.current && portfolioGridRef.current) {
            const tl = gsap.timeline({
                scrollTrigger: {
            ...
            tl.fromTo(portfolioHeaderRef.current.children,
                { y: 30, opacity: 0 },
                { y: 0, opacity: 1, duration: 0.8, stagger: 0.2, ease: "power2.out" }
            );

            tl.fromTo(portfolioGridRef.current.children,
                { y: 40, opacity: 0 },
    ...
    return (
        <main className="flex min-h-screen flex-col items-center">
            ...
            {/* What is Branding & Design? Section */}
            <section ref={introSectionRef} className="w-full bg-white !py-4 md:!py-24 !px-4 md:!px-6 overflow-hidden">
                <div className="max-w-7xl !mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20">
                    ...
                    <div ref={introVisualRef} className="hidden md:block w-full md:w-1/2 relative h-[300px] md:h-[450px]">
                        ...
                        <NextImage
                            src="/services/brandidentity.jpg"
                            alt="Branding and Design Visual"
                            fill
                    ...
                    <div ref={introContentRef} className="w-full md:w-1/2 space-y-6 text-left">
                        <span className="text-[#2197A1] font-black uppercase tracking-widest text-xs !mb-3 block">Defining Design</span>
                        <h2 className="text-4xl md:text-5xl font-bold text-[#2A2A2A] !mb-3 leading-tight">
                            What is <br /><span className="text-[#2197A1]">Branding & Design?</span>
                        </h2>
                        ...
                        <div className="space-y-6 text-lg md:text-xl text-[#2A2A2A]/70 leading-relaxed font-medium">
                            <p>
                                <span className="font-bold">Branding and design</span> help your business look <span className="font-bold">professional</span> and <span className="font-bold">build trust</span> with customers. A good logo and clean design make your business more attractive and easy to remember.
                            </p>
                            <p>
                                At <span className="font-bold">Prodbiz Solutions</span>, we provide branding and design services like <span className="font-bold">logo design, posters, and social media creatives</span>. We create designs that match your business and help you grow your <span className="font-bold">online presence</span> and reach more customers.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            {/* What We Design Section - Premium 3D Pedestal Version */}
            <section ref={offerSectionRef} className="relative w-full bg-white !pt-15 md:!pt-20 !px-0 overflow-hidden">
                ...
                <div className="relative z-10 !mx-auto">
                    <div ref={offerHeaderRef} className="text-center !mb-1 md:!mb-24">
                        <span className="text-[#2197A1] font-black uppercase tracking-widest text-xs !mb-3 block">Expert Services</span>
                        <h2 className="text-4xl md:text-5xl font-black !text-[#1E293B] !mb-2 md:!mb-4 leading-tight tracking-tighter">
                            What We Design for <span className="text-[#2197A1]">Your Business</span>
                        </h2>
                        <div className="w-24 h-1 bg-[#e76038] !mx-auto rounded-full shadow-[0_0_20px_rgba(33,151,161,0.5)]"></div>
                    </div>

                    <div ref={offerCardsRef} className="hidden md:flex flex-wrap justify-center items-start gap-x-12 gap-y-24 md:gap-y-0">
                        {designServices.map((service, index) => (
                            ...
                            > 
                                ...
                                <div className="relative z-20 !mb-[50px] md:!mb-[-10px] animate-float" style={{ animationDelay: `${index * 0.5}s` }}>
                                ...
                                {/* 3D Podium/Pedestal */}
                                <div className="relative w-48 md:w-56 h-20 !mb-1 md:!mb-10 transition-transform duration-700 group-hover:scale-105">
                                    {/* Side Body */}
                    ...
                    <div ref={mobileOfferCardsRef}>
                        <MobileServiceCarousel items={designServices} />
                    </div>
                </div>
            ...
            <section ref={portfolioSectionRef} className="w-full bg-[#fff] overflow-hidden !py-24 md:!pt-48 md:!pb-0">
                <div className="max-w-7xl !mx-auto !px-6">
                    <div ref={portfolioHeaderRef} className="hidden md:block text-center !mb-16 md:!mb-0">
                        ...
                        <h2 className="text-4xl md:text-6xl font-black text-white !mb-2 md:!mb-6 leading-tight">
                            Our <span className="text-[#2197A1]">Design Work</span>
                        </h2>
                        <div className="w-24 h-1.5 bg-[#e76038] !mx-auto rounded-full shadow-[0_0_15px_rgba(231,96,56,0.4)]"></div>
                    </div>
                </div>

                {/* Circular Gallery Container - Desktop only */}
            ...
            <section ref={whyChooseUsSectionRef} className="relative bg-[#fff] w-full md:!pt-0 md:!pb-32 !px-4 md:!px-6 min-[1150px]:max-[1299px]:!px-2 overflow-hidden">
                ...
                <div className="md:max-w-7xl !mx-auto relative z-10">
                    <div ref={whyChooseUsHeaderRef} className="text-center md:!mb-16">
                        ...
                        <h2 className="text-4xl md:text-5xl font-black text-[#2A2A2A] !mb-4 leading-tight">
                            Why Choose Prodbiz Solutions for <span className="text-[#2197A1]">Branding & Design</span>
                        </h2>
                        ...
                        <p className="text-[#2A2A2A]/70 max-w-4xl !mx-auto text-lg leading-relaxed !mt-4 md:!mt-10 font-medium">
                            Simple, creative, and professional design services to help your business stand out and grow online
                        </p>
                    </div>
                    ...
                    <div ref={whyChooseUsCardsRef} className="hidden md:grid grid-cols-1 md:grid-cols-2 min-[1150px]:!grid-cols-4 xl:!grid-cols-4 gap-12 gap-y-16 min-[1150px]:max-[1299px]:!gap-4 lg:gap-8 justify-items-center" style={{ perspective: "1500px" }}>
                        {whyChooseUsData.map((item, index) => (
                            <div key={index} className="group relative w-full max-w-[310px] min-[1150px]:max-[1299px]:max-w-[250px] aspect-square rounded-full flex flex-col items-center justify-center text-center cursor-default transition-all duration-700 transform-gpu hover:[transform:rotateX(10deg)rotateY(10deg)translateZ(30px)] shadow-lg hover:shadow-2xl">
                                ...
                                <div className="absolute inset-0 rounded-full overflow-hidden z-0 bg-white border border-[#2197A1]/10 shadow-inner">
                                    ...
                                    <div className="absolute top-1/2 right-0 translate-x-[35%] -translate-y-1/2 w-[110px] h-[110px] min-[1150px]:max-[1299px]:w-[80px] min-[1150px]:max-[1299px]:h-[80px] bg-[#2197A1] transition-all duration-500 rounded-full flex items-center justify-start pl-6 min-[1150px]:max-[1299px]:pl-4 shadow-lg">
                                        <span className="text-white font-black !pl-5 min-[1150px]:max-[1299px]:!pl-4 !text-xl min-[1150px]:max-[1299px]:!text-lg transform -translate-y-[2px]">0{index + 1}</span>
                                    </div>
                                ...
                                {/* Main Content */}
                                <div className="relative !left-[-25px] min-[1150px]:max-[1299px]:!left-[-15px] !w-[200px] min-[1150px]:max-[1299px]:!w-[170px] z-20 flex flex-col items-center pt-2 pl-1 pr-14 min-[1150px]:max-[1299px]:pr-10 text-center">
                                    <div className="text-[#2197A1] transition-colors duration-500 !mb-4 transform group-hover:scale-110 drop-shadow-sm min-[1150px]:max-[1299px]:scale-90">
                                        {item.icon}
                                    </div>
                                    <h3 className="text-[#2A2A2A] font-bold !text-[14px] md:text-xs uppercase tracking-widest mb-3 leading-snug">
                                        {item.title}
                                    </h3>
                                    <p className="text-[#2A2A2A]/60 !text-[14px] leading-[1.6] line-clamp-4 font-medium">
                                        {item.desc}
                                    </p>
                                </div>
                            </div>
