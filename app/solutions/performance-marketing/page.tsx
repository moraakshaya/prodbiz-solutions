            ...
            >
                ...
                <div className="z-10 w-full max-w-7xl !mx-auto flex flex-col lg:flex-row items-center !px-4 md:px-6 !pt-3 sm:!pt-15 lg:!pt-10 gap-1 sm:gap-10 lg:gap-5">
                    ...
                    <div className="w-full lg:w-[60%] flex flex-col items-center lg:items-start text-center lg:text-left lg:translate-y-[-20px] pr-0">
                        <span className="hidden md:block text-[#e76038]/80 font-bold text-sm uppercase tracking-widest md:!mb-4">Precision Growth</span>
            ...
            <section className="relative w-full bg-white !pt-10 md:!py-20 !px-10 md:px-12 lg:px-24 overflow-hidden">
                <div className="max-w-7xl !mx-auto">
                    <div className="text-center !mb-10">
                        <h2 className="text-4xl md:text-6xl font-black text-[#2A2A2A] mb-4 tracking-tight">Campaign Timeline</h2>
                    ...
                    <div className="relative max-w-5xl !mx-auto pt-20 pb-40">
                        ...
                        <div className="hidden md:block">
                            ...
                            <div className="relative z-10 w-full h-[600px]">
                                {/* Step 1 */}
                                <div className="absolute top-[140px] left-[25%] -translate-x-1/2 -translate-y-1/2 group">
                                ...
                                {/* Step 2 */}
                                <div className="absolute top-[130px] left-[75%] -translate-x-1/2 -translate-y-1/2 group">
                                    <div className="flex flex-col items-center">
                ...
                <div className="relative z-10 max-w-7xl !mx-auto flex flex-col lg:flex-row items-center gap-0 md:gap-20">
                    <div className="w-full lg:w-[40%] text-left">
                        ...
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-8 leading-tight drop-shadow-lg">
                            Performance <br />
                            <span className="text-[#e76038]">Ad Tech Stack</span>
                        </h2>
                        <p className="text-lg text-white/90 font-medium leading-relaxed mb-10 max-w-lg drop-shadow-md">
                            We use advanced marketing platforms and analytics tools to ensure accurate campaign tracking and optimization.
                        </p>
                        <div className="flex flex-col gap-5">
                            {["Advanced Tracking APIs", "Automated Bidding Engines", "Cross-Platform Analytics"].map((item, i) => (
