        ...
        <main className="flex min-h-screen flex-col items-center">
                ...
                <div className="z-10 w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center px-6">
                    ...
                    <div className="w-full md:w-[70%] !pl-[14%] flex flex-col items-start">
                        <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-[#2A2A2A] mb-6">
                            Performance <br />
                            <span className="text-[#2197A1]">Marketing</span>
                        </h1>
                        <p className="text-lg md:text-xl text-[#2A2A2A]/80 font-medium max-w-3xl">
                            Data-driven strategies to maximize your ROI and accelerate business growth.
                            We combine analytics, creative content, and strategic targeting to deliver
            ...
            <section className="w-full bg-white py-20 px-6 sm:px-12 lg:px-24">
                <div className="max-w-7xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#2A2A2A] mb-8">Drive Real Business Growth</h2>
                    <p className="text-lg text-gray-500 max-w-3xl mx-auto">
                        Performance marketing is about more than just traffic—it's about the right traffic.
                        We help you identify your ideal audience, craft compelling messages, and optimize
                        every touchpoint to convert clicks into customers.
                    </p>
                </div>
            </section>
