...
const buildServices = [
    {
        ...
        desc: "Simple and professional websites for your business",
        icon: <Monitor size={42} strokeWidth={1.5} />
    },
    {
        title: "E-commerce Websites",
        desc: "Online stores to sell your products",
        icon: <ShoppingCart size={42} strokeWidth={1.5} />
    },
    {
        title: "Mobile-Friendly Design",
        desc: "Websites that work smoothly on phones and tablets",
        icon: <Smartphone size={42} strokeWidth={1.5} />
    },
    {
        title: "Fast & SEO-Friendly",
        desc: "Websites that load fast and rank better on Google",
        icon: <Cpu size={42} strokeWidth={1.5} />
    },
    {
        title: "Website Maintenance",
        desc: "We update and manage your website when needed",
...
const whyChooseUsData = [
    {
        ...
        desc: "We create professional website designs that look attractive, build trust, and improve your brand image.",
        icon: <Layout size={32} />
    },
    {
        title: "Mobile-friendly websites",
        desc: "Your website works smoothly on mobile, tablet, and desktop, helping you reach more users online.",
        icon: <Smartphone size={32} />
    },
    {
        title: "Fast & SEO-Friendly",
        desc: "We build fast-loading websites with SEO best practices to help you rank better on search engines and bring more traffic.",
        icon: <Zap size={32} />
    },
    {
        title: "Support after delivery",
        desc: "We provide ongoing website support and maintenance to keep your site updated and running smoothly.",
...
export default function WebsiteDevelopmentPage() {
    ...
    const titleText = "We Build Websites That Convert & Grow";
    const paraText = "From stunning landing pages to powerful e-commerce stores, we craft fast, responsive, and SEO-optimised websites that turn visitors into loyal customers.";
    const smallLineText = "Fast, Secure, and Scalable Digital Experiences.";
    ...
    useEffect(() => {
        ...
        // --- What We Build Section Animation ---
        ...
        <main className="flex min-h-screen flex-col items-center">
            ...
            <section className="relative w-full min-h-[75vh] min-[340px]:min-h-[60vh] min-[360px]:min-h-[75vh] min-[380px]:min-h-[60vh] min-[400px]:min-h-[58vh] min-[540px]:min-h-[68vh] min-[760px]:min-h-[66vh] min-[1024px]:min-h-[80vh] min-[1150px]:min-h-[100vh] flex items-center justify-center overflow-hidden pt-16 min-[760px]:pt-0">
                ...
                <div className="z-10 text-center !px-4 md:!px-6 max-w-5xl mx-auto flex flex-col items-center">
                    <h1 ref={titleRef} className="font-bold !text-[#2197a1] md:!mb-6 drop-shadow-md text-4xl lg:text-6xl perspective-1000">
                ...
                <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] transform translate-y-[1px]">
                    ...
                    {/* Mobile Wavy Border */}
                    <svg
                        className="md:hidden relative block w-[calc(100%+1.3px)] h-[60px]"
                        data-name="Layer 1"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 600 60"
                        preserveAspectRatio="none"
                    >
                        <path
                            d="M0,60V23.14c23.89,11.1,51.79,16.08,79,14,35.18-2.68,68.16-16.65,103.4-18.75,36.92-2.18,73.77,8.44,109.2,17.63,34.63,9,69.15,12.44,104.7,6.54,18.07-3,34.92-8.92,52.22-14.67C494.74,12.5,556.5-7.14,600,26.23V60H0Z"
                            className="fill-white/10"
                            opacity="0.3"
                        ></path>
                        <path
                            d="M0,60V7.9c6.5,10.55,13.82,20.52,23.84,28.12,25.86,19.61,58.65,19.47,88.45,9.76a171.7,171.7,0,0,0,44.83-19.9c20.46-9.5,42.36-23,65.41-24.83,18.13-1.43,35.47,4.71,52.95,10.22,29.63,9.34,56.77,21.68,86.27,29.61,22,5.91,51.31,7,65.86-12.28s5.76-36.84,5.76-36.84V60H0Z"
                            className="fill-white/20"
                            opacity="0.5"
                        ></path>
                        <path
                            d="M0,60V2.81C74.96,29.5,157.05,35.66,237.91,21.28c21.5-3.82,42.11-10.06,63.8-13.23,29.5-4.32,56.24,6.12,82.78,17.7,46.54,20.33,75.58,29.34,108.18,26.72,43.26-3.5,86.23-22.85,124.4-42.4V60H0Z"
                            className="fill-white"
                        ></path>
                    </svg>
                </div>
            ...
            <section ref={introSectionRef} className="w-full bg-white !py-4 md:!py-24 !px-4 md:!px-6 overflow-hidden">
                <div className="max-w-7xl !mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20">
                    ...
                    <div ref={introVisualRef} className="hidden md:block w-full md:w-1/2 relative h-[300px] md:h-[450px]">
                        ...
                        <NextImage
                            src="/brain/47a2892c-4fc3-4a46-8966-688ff5c9cd1e/website_dev_intro_visual_1777536345566.png"
                    ...
                    <div ref={introContentRef} className="w-full md:w-1/2 space-y-6 text-left">
                        <span className="text-[#2197A1] font-black uppercase tracking-widest text-xs !mb-3 block">Digital Presence</span>
                        <h2 className="text-4xl md:text-5xl font-bold text-[#2A2A2A] !mb-3 leading-tight">
                            Why Your Business <br /><span className="text-[#2197A1]">Needs a Website</span>
                        </h2>
                        ...
                        <div className="space-y-6 text-lg md:text-xl text-[#2A2A2A]/70 leading-relaxed font-medium">
                            <p>
                                A business website helps people easily find you on <span className="font-bold">Google search</span> and learn about your services, products, and contact details. It <span className="font-bold">builds trust</span>, improves your <span className="font-bold">online presence</span>, and makes your brand look <span className="font-bold">professional and reliable</span>. Today, most customers search online before choosing a service, so without a website, your business may miss many <span className="font-bold">potential customers</span>.
                            </p>
                            <p>
                                At <span className="font-bold">Prodbiz Solutions</span>, we create <span className="font-bold">modern, responsive websites</span> that work smoothly on <span className="font-bold">mobile, tablet, and desktop</span> devices. Our websites <span className="font-bold">load fast</span>, are <span className="font-bold">SEO-friendly</span>, and are designed to be <span className="font-bold">simple and easy</span> for your customers to use. We focus on helping your business <span className="font-bold">attract more visitors</span>, <span className="font-bold">generate leads</span>, and <span className="font-bold">grow online successfully</span>.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            {/* What We Build Section - Premium 3D Pedestal Version */}
            <section ref={offerSectionRef} className="relative w-full bg-white !pt-15 md:!pt-20 !px-0 overflow-hidden">
                ...
                <div className="relative z-10 !mx-auto">
                    <div ref={offerHeaderRef} className="text-center !mb-1 md:!mb-24">
                        <span className="text-[#2197A1] font-black uppercase tracking-widest text-xs !mb-1 md:!mb-3 block">Expert Development</span>
                        <h2 className="text-4xl md:text-5xl font-black !text-[#1E293B] !mb-2 md:!mb-4 leading-tight tracking-tighter">
                            What We Build for <span className="text-[#2197A1]">Your Business</span>
                        </h2>
                    ...
                    <div ref={mobileOfferCardsRef}>
                        <MobileServiceCarousel items={buildServices} />
                    </div>
                </div>
                ...
                <div className="max-w-7xl !mx-auto !px-6">
                    <div ref={portfolioHeaderRef} className="text-center !mb-16 md:!mb-0">
                        ...
                        <h2 className="text-4xl md:text-6xl font-black text-[#2A2A2A] !mb-2 md:!mb-6 leading-tight">
                            Our <span className="text-[#2197A1]">Build Work</span>
                        </h2>
            ...
            <section ref={whyChooseUsSectionRef} className="relative bg-[#fff] w-full md:!pt-0 md:!pb-32 !px-6 min-[1150px]:max-[1299px]:!px-2 overflow-hidden">
                ...
                <div className="md:max-w-7xl !mx-auto relative z-10">
                    <div ref={whyChooseUsHeaderRef} className="text-center md:!mb-16">
                        ...
                        <h2 className="text-4xl md:text-5xl font-black text-[#2A2A2A] !mb-4 leading-tight">
                            Why Choose Prodbiz for <br /><span className="text-[#2197A1]">Website Development</span>
                        </h2>
                        ...
                        <p className="text-[#2A2A2A]/70 max-w-4xl !mx-auto text-lg leading-relaxed !mt-4 md:!mt-10 font-medium">
                            We build high-performance, responsive websites that help your business grow and reach more customers online.
                        </p>
                    </div>
