...
const creativeIcons = [
    ...
    { icon: Video, color: "#2197A1", label: "Motion" },
    { icon: Palette, color: "#e76038", label: "Design" },
    { icon: Film, color: "#2197A1", label: "Story" },
    { icon: MonitorPlay, color: "#e76038", label: "Screen" },
];

const services = [
    {
        image: "/services/videograpghy.jpg",
        title: "Video Production",
        description: "From concept to final edit, we create high-impact video content that tells your brand's story. Our team specializes in brand films, commercials, and social media content that drives engagement and captures attention.",
        highlights: ["Scriptwriting & concept development", "High-definition filming", "Post-production & motion graphics", "Sound design & color grading", "Social media video optimization"]
    },
    {
        image: "/services/brandidentity.jpg",
        title: "Brand Identity Design",
        description: "We build powerful brand identities that stand out in crowded markets. Our design process ensures your brand's visual elements are cohesive, memorable, and aligned with your business values.",
        highlights: ["Logo design & typography", "Color palette & visual systems", "Brand guidelines & standards", "Stationery & marketing collateral", "Brand asset management"]
    },
    {
        image: "/services/photography.png",
        title: "Photography & Visual Content",
        description: "High-quality imagery is essential for any modern brand. We provide professional photography services for products, lifestyle, and corporate needs, ensuring your brand looks its best across all platforms.",
        highlights: ["Product & lifestyle photography", "Corporate & team portraits", "Event coverage & documentation", "Image editing & retouching", "Creative art direction"]
    },
    {
        image: "/services/motiongraphic.webp",
        title: "Motion Graphics",
        description: "Bring your brand to life with dynamic motion graphics and animation. We create visual effects that explain complex ideas, enhance video content, and capture the interest of your digital audience.",
        highlights: ["2D & 3D animation", "Explainer videos", "Animated social media assets", "Logo animation", "Visual effects (VFX)"]
    }
];
...
const processSteps = [
    {
        ...
        description: "We brainstorm and develop creative concepts that align with your brand's goals and message.",
        icon: <Palette size={24} />
    },
    {
        number: "02",
        title: "Pre-Production",
        description: "Planning every detail from storyboards to scheduling ensures a smooth production process.",
        icon: <Film size={24} />
    },
    {
        number: "03",
        title: "Production & Filming",
        description: "Our professional crew captures high-quality visuals using state-of-the-art equipment.",
        icon: <Video size={24} />
    },
    {
        number: "04",
        title: "Post-Production",
        description: "We edit, refine, and polish the content to deliver a final masterpiece that wows your audience.",
        icon: <MonitorPlay size={24} />
    }
];

const technologies = [
    { name: "Adobe Illustrator", image: "/tools/adodeai.png" },
    { name: "DaVinci Resolve", image: "/tools/davinciresolve.png" },
    { name: "Photoshop", image: "/tools/photoshop.png" },
    { name: "Blender", image: "/tools/blender.png" },
            ...
            <section ref={timelineSectionRef} className="relative w-full bg-white !pt-10 md:!py-20 !px-10 md:px-12 lg:px-24 overflow-hidden">
                <div className="max-w-7xl !mx-auto">
                    ...
                    <div className="relative max-w-5xl !mx-auto pt-20 pb-40">
                        {/* Desktop Serpentine Timeline (SVG) — Matched to Data Analytics */}
                        <div className="hidden md:block">
                            <svg className="absolute inset-0 w-full h-full pointer-events-none overflow-visible" viewBox="0 0 1000 600" preserveAspectRatio="none">
                                <defs>
                                    <linearGradient id="creativePathGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                                ...
                                <path
                                    ...
                                    fill="none"
                                    stroke="url(#creativePathGradient)"
                                    strokeWidth="6"
                                    strokeLinecap="round"
                                ...
                                <path
                                    ...
                                    className="animate-[dash-creative_60s_linear_infinite]"
                                />
                            </svg>
                            ...
                            <div ref={timelineDesktopStepsRef} className="relative z-10 w-full h-[600px]">
                                ...
                                <div className="absolute top-[520px] left-[80%] -translate-x-1/2 -translate-y-1/2 group">
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div className="!mt-14 text-center w-64 lg:w-80 group-hover:-translate-y-2 transition-transform duration-500">
                                            <h3 className="text-2xl font-black text-gray-300 mb-2 uppercase italic group-hover:text-[#e76038] transition-colors">{processSteps[3].title}</h3>
