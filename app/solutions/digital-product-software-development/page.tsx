...
const services = [
    {
        ...
        description: "We design modern, responsive websites that provide seamless user experiences across all devices while ensuring performance, security, and scalability.",
        highlights: ["Responsive design", "SEO-friendly structure", "High performance optimization"]
    },
    {
        image: "/services/webapplication.jpg",
        title: "Web Application Development",
        description: "Complex, feature-rich web applications built for performance, security, and seamless user interaction.",
        highlights: ["Scalable architecture", "Interactive UI/UX", "Enterprise-grade security"]
    },
    {
        image: "/services/api.webp",
        title: "API Development & Integrations",
        description: "Seamless connectivity between your systems with robust, secure, and highly efficient API architectures.",
        highlights: ["System interoperability", "Secure data flow", "Custom API endpoints"]
    },
    {
        image: "/services/hrm.png",
        title: "HRM Software Solutions",
        description: "Custom Human Resource Management systems designed to streamline your workforce, payroll, and operations.",
        highlights: ["Workflow automation", "Payroll management", "Employee tracking"]
    }
];
...
const processSteps = [
    {
        ...
        description: "We begin by understanding your business goals, target audience, and technical requirements to define the right development strategy.",
        icon: <Code2 size={24} />
    },
    {
        number: "02",
        title: "Design & Architecture",
        description: "Our team designs user-friendly interfaces and builds a solid technical architecture to ensure scalability and performance.",
        icon: <Layers size={24} />
    },
    {
        number: "03",
        title: "Development & Testing",
        description: "Using modern technologies and best coding practices, we develop your product and perform thorough testing to ensure reliability.",
        icon: <Database size={24} />
    },
    {
        number: "04",
        title: "Launch & Support",
        description: "Once the product is ready, we launch it smoothly and provide ongoing support, updates, and maintenance.",
        icon: <Workflow size={24} />
    }
];

const technologies = [
    { name: "React.JS", image: "/tools/react.png" },
    { name: "Firebase", image: "/tools/firebase.png" },
    { name: "Node.JS", image: "/tools/node.png" },
    { name: "Javascript", image: "/tools/js.png" },
    { name: "Tailwind CSS", image: "/tools/tailwindcss.png" },
    { name: "Express.JS", image: "/tools/expressjs.png" },
];
...
export default function DigitalProductSoftwareDevelopmentPage() {
    ...
    useEffect(() => {
        ...
        if (heroSubtitleRef.current && heroTitleRef.current && heroParaMobileRef.current && heroParaDesktopRef.current && heroButtonsRef.current) {
            ...
            heroTl.fromTo([splitMobilePara.lines, splitDesktopPara.lines] as any,
                ...
                "-=1.2" // Starts just before span finishes it's FIRST animation
            );
        ...
        if (servicesSectionRef.current && servicesSubtitleRef.current && 
            ...
            // 1. Span (Subtitle): Slide Up
            tl.fromTo(servicesSubtitleRef.current,
                { y: 30, opacity: 0 },
                { y: 0, opacity: 1, duration: 0.8, ease: "power2.out" }
            );

            // 2. H2 Title: Fade + Slide Up
            tl.fromTo(servicesTitleRef.current,
                { y: 40, opacity: 0 },
                { y: 0, opacity: 1, duration: 1.0, ease: "power3.out" },
                "-=0.6" // Starts Before subtitle finishes
            );
            ...
            tl.fromTo(servicesGridRef.current.children,
                ...
                "-=0.7" // Starts Before title finishes
            );
        }
        ...
        if (techSectionRef.current && techSubtitleRef.current && techTitleRef.current && 
            ...
            // 0. Split the paragraph into lines
            ...
            // 3. Paragraph: Line-by-line fade + slide up
            ...
            // 4. List Items & Center Hub: Fade + Slide/Pop
            ...
            // 5. Bloom Petals: Staggered reveal
    ...
    return (
        <main className="flex min-h-screen flex-col items-center">
            {/* Digital Product Hero Section - Matched to About Page */}
            <section
            ...
            >
                ...
                <div className="z-10 w-full max-w-7xl !mx-auto flex flex-col lg:flex-row items-center !px-4 md:px-6 !pt-3 sm:!pt-15 lg:!pt-10 gap-1 sm:gap-10 lg:gap-5">
                    ...
                    <div className="w-full lg:w-[60%] flex flex-col items-center lg:items-start text-center lg:text-left lg:translate-y-[-20px] pr-0">
                        <span ref={heroSubtitleRef} className="hidden md:block text-[#e76038]/80 font-bold text-sm uppercase tracking-widest md:!mb-4">Innovation & Code</span>
                        ...
                        <div className="space-y-4 max-w-3xl !mb-0 md:!mb-8">
                            <p ref={heroParaMobileRef} className="block md:hidden text-sm sm:text-base text-[#2A2A2A]/80 font-medium leading-snug text-center">
                                We transform bold ideas into powerful digital realities with scalable, future-proof software solutions.
                            </p>
                            <div className="hidden md:block">
                                <p ref={heroParaDesktopRef} className="text-lg md:text-xl text-[#2A2A2A]/80 font-medium leading-relaxed">
                                    We transform bold ideas into powerful digital realities. Our expert team builds
                                    scalable, future-proof software solutions that drive innovation and
            ...
            <section ref={servicesSectionRef} className="relative w-full bg-white !pt-10 md:!py-20 !px-3 md:px-12 lg:px-24 overflow-hidden">
                <div className="relative z-10 max-w-7xl !mx-auto">
                    <div className="text-center !mb-10">
                        ...
                        <h2 ref={servicesTitleRef} className="text-4xl md:text-6xl font-bold text-[#2A2A2A] mb-8">Our Development Services</h2>
                    </div>
                        ...
                        {services.map((service, index) => (
                            ...
                            >
                                <div className="h-full bg-[#2197A1]/20 border border-gray-100 !px-4 !py-5 md:!p-5 rounded-[3.5rem] transition-all duration-500 transform-gpu group-hover:[transform:rotateX(2deg)rotateY(2deg)] group-hover:bg-[#2197A1]/10 group-hover:border-[#2197A1]/10 shadow-[0_10px_30px_rgba(0,0,0,0.03)] group-hover:shadow-[0_40px_80px_rgba(0,0,0,0.1)] flex flex-col items-start overflow-hidden">
                                    ...
                                    <p className="relative top-20 bottom-0 left-0 right-0 "></p>
            ...
            <section ref={timelineSectionRef} className="relative w-full bg-white !pt-20 md:!py-20 !px-10 md:px-12 lg:px-24 overflow-hidden">
                <div className="max-w-7xl !mx-auto">
                    <div className="text-center !mb-10">
                        <h2 ref={timelineTitleRef} className="text-4xl md:text-6xl font-black text-[#2A2A2A] mb-4 tracking-tight uppercase">Milestone TIMELINE</h2>
                        <p ref={timelineParaRef} className="text-gray-400 text-lg max-w-2xl !mx-auto font-medium">
                            A step-by-step roadmap of how we bring your visionary products to life.
                        </p>
                    </div>
                ...
                <div className="relative z-10 max-w-7xl !mx-auto flex flex-col lg:flex-row items-center gap-0 md:gap-20">
                    <div className="w-full lg:w-[40%] text-left">
                        ...
                        <h2 ref={techTitleRef} className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-8 leading-tight drop-shadow-lg">
                            Powerful <br />
                            <span className="text-[#e76038]">Development Stack</span>
                        </h2>
                        <p ref={techParaRef} className="text-lg text-white/90 font-medium leading-relaxed mb-10 max-w-lg drop-shadow-md">
                            We use modern technologies and industry best practices to build high-performance, secure, and scalable digital products that deliver real business value.
                        </p>
                        <div ref={techItemsRef} className="flex flex-col gap-5">
                            {["Scalable Architecture", "State-of-the-Art Security", "Cloud-Native Infrastructure"].map((item, i) => (
