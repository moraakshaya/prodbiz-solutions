...
const growthServicesData = [
    {
        ...
        desc: "We create your website and set up your social media so your business is visible online.",
        icon: <Globe size={42} strokeWidth={1.5} />
    },
    {
        title: "Lead Generation",
        desc: "We help you get calls, messages, and inquiries from people interested in your services.",
        icon: <PhoneIncoming size={42} strokeWidth={1.5} />
    },
    {
        title: "Full Digital Strategy",
        desc: "We plan the right steps to promote your business and reach the right audience.",
        icon: <Layout size={42} strokeWidth={1.5} />
    },
    {
        title: "Brand Growth Planning",
        desc: "We help your brand grow and become more popular and trusted.",
        icon: <TrendingUp size={42} strokeWidth={1.5} />
    },
    {
        title: "End-to-End Support",
        desc: "We support you from the beginning and continue helping you as your business grows.",
        icon: <Handshake size={42} strokeWidth={1.5} />
    }
];
...
const whyChooseUsData = [
    {
        ...
        desc: "Get complete digital solutions for your business in one place.",
        icon: <Layers size={32} />
    },
    {
        title: "No need for multiple teams",
        desc: "We handle everything, so you don’t need separate design, development, and marketing teams.",
        icon: <Users size={32} />
    },
    {
        title: "Focus on real customers",
        desc: "We use lead generation strategies to bring real customers to your business.",
        icon: <Target size={32} />
    },
    {
        title: "Simple process & full support",
        desc: "We follow a clear process and provide support from start to business growth.",
        icon: <Activity size={32} />
    }
];

export default function CompleteBusinessGrowthPage() {
    ...
    const titleText = "Complete Business Growth";
    const paraText = "Everything your business needs to grow online and get more customers.";
    const smallLineText = "From websites to marketing, we handle everything to grow your business.";
    ...
    return (
        <main className="flex min-h-screen flex-col items-center">
            ...
            {/* Everything You Need to Grow Your Business Section */}
            <section ref={introSectionRef} className="w-full bg-white !py-4 md:!py-24 !px-6 overflow-hidden">
                <div className="max-w-7xl !mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-10">
                    {/* Left Side: Visual */}
                    ...
                    <div ref={introContentRef} className="w-full md:w-1/2 space-y-6 text-left">
                        <span className="text-[#2197A1] font-black uppercase tracking-widest text-xs !mb-3 block">Infinite Scale</span>
                        ...
                        <div className="space-y-6 text-lg md:text-xl text-[#2A2A2A]/70 leading-relaxed font-medium">
                            <p>
                                Growing a business today needs more than just one service. You need <span className="font-bold">branding, a professional website, quality content, and digital marketing</span> all working together to get <span className="font-bold">real results</span>. Managing different people for each task can be confusing, time-consuming, and costly, which is why having <span className="font-bold">everything in one place</span> makes your business growth <span className="font-bold">easier and faster</span>.
                            </p>
                            <p>
                                At <span className="font-bold">Prodbiz Solutions</span>, we provide <span className="font-bold">complete business growth services</span>. From building your brand and creating your online presence to promoting your business through <span className="font-bold">digital marketing</span>, we handle everything <span className="font-bold">step by step</span>. We help your business <span className="font-bold">increase online visibility</span>, <span className="font-bold">reach the right target audience</span>, <span className="font-bold">build a strong and professional brand</span>, and <span className="font-bold">generate more leads and customers</span>. Our goal is simple — to help your business <span className="font-bold">grow smoothly and succeed</span> in the digital world.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            {/* What We Do for Your Business Growth - Premium 3D Pedestal Version */}
            <section ref={offerSectionRef} className="relative w-full bg-white !pt-15 md:!pt-20 !px-4 md:!px-0 overflow-hidden">
                ...
                <div className="relative z-10 !mx-auto">
                    <div ref={offerHeaderRef} className="text-center !mb-1 md:!mb-24">
                        <span className="text-[#2197A1] font-black uppercase tracking-widest text-xs !mb-1 md:!mb-3 block">Complete Success</span>
                        <h2 className="text-4xl md:text-5xl font-black !text-[#1E293B] !mb-2 md:!mb-4 leading-tight tracking-tighter">
                            What We Do for Your <span className="text-[#2197A1]">Business Growth</span>
                        </h2>
                    ...
                    <div ref={mobileOfferCardsRef}>
                        <MobileServiceCarousel items={growthServicesData} />
                    </div>
                </div>
                ...
                <div className="max-w-7xl !mx-auto !px-6">
                    <div ref={portfolioHeaderRef} className="text-center !mb-16 md:!mb-0">
                        ...
                        <h2 className="text-4xl md:text-6xl font-black text-[#2A2A2A] !mb-2 md:!mb-6 leading-tight">
                            Our <span className="text-[#2197A1]">Growth Work</span>
                        </h2>
                ...
                <div className="md:max-w-7xl !mx-auto relative z-10">
                    <div ref={whyChooseUsHeaderRef} className="text-center md:!mb-16">
                        ...
                        <p className="text-[#2A2A2A]/70 max-w-4xl !mx-auto text-lg leading-relaxed !mt-4 md:!mt-10 font-medium">
                            We provide complete digital solutions in one place, handling everything to help your business grow smoothly.
                        </p>
                    </div>
