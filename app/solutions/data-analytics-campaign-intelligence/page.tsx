...
const analyticsIcons = [
    { icon: Activity, color: "#e76038", label: "Performance" },
    { icon: PieChart, color: "#2197A1", label: "Analysis" },
    { icon: TrendingUp, color: "#e76038", label: "ROI" },
    { icon: MousePointerClick, color: "#2197A1", label: "Conversion" },
    { icon: Database, color: "#e76038", label: "Data" },
];

const services = [
    {
        image: "/services/campaginanalysics.jpg",
        title: "Campaign Performance Tracking",
        description: "Gain 360-degree visibility into your marketing efforts with real-time dashboards and cross-channel performance tracking to maximize your ROI.",
        highlights: ["Real-time Dashboards", "Cross-channel Tracking", "ROI Optimization", "Competitor Benchmarking", "Custom KPI Reports"]
    },
    {
        image: "/services/marketing-analysit.jpg",
        title: "Marketing Analytics",
        description: "Transform your raw marketing data into powerful insights with advanced analytics, helping you make data-driven decisions that drive measurable business growth.",
        highlights: ["Customer Segmentation", "Attribution Modeling", "Conversion Analysis", "Trend Forecasting", "Data Visualization"]
    }
];
...
const processSteps = [
    {
        ...
        description: "We gather marketing and user interaction data from multiple digital platforms.",
        icon: <Database size={24} />
    },
    {
        number: "02",
        title: "Data Analysis",
        description: "Our team analyzes campaign performance, audience behavior, and engagement metrics.",
        icon: <LineChart size={24} />
    },
    {
        number: "03",
        title: "Insight Generation",
        description: "We transform complex data into clear insights that help guide marketing decisions.",
        icon: <BrainCircuit size={24} />
    },
    {
        number: "04",
        title: "Optimization & Reporting",
        description: "We continuously optimize campaigns and provide performance reports to ensure measurable growth.",
        icon: <Activity size={24} />
    }
];

const technologies = [
    { name: "Google Analytics", image: "/tools/google-analytics.png" },
    { name: "Ahrefs", image: "/tools/ahrefs.png" },
    { name: "Google Tags Manager", image: "/tools/google-meta-tags.png" },
    { name: "Meta Ads Manager", image: "/tools/meta-ads-manager.png" },
    { name: "Google Ads", image: "/tools/google-ads.png" }
];

export default function DataAnalyticsCampaignIntelligencePage() {
    ...
    return (
        <main className="flex min-h-screen flex-col items-center">
            {/* Data Analytics Hero Section - Matched to About Page */}
            <section
            ...
            >
                ...
                <div className="z-10 w-full max-w-7xl !mx-auto flex flex-col lg:flex-row items-center !px-4 md:px-6 !pt-3 sm:!pt-15 lg:!pt-10 gap-1 sm:gap-10 lg:gap-5">
                    ...
                    <div className="w-full lg:w-[60%] flex flex-col items-center lg:items-start text-center lg:text-left lg:translate-y-[-20px] pr-0">
                        <span ref={heroSubtitleRef} className="hidden md:block text-[#e76038]/80 font-bold text-sm uppercase tracking-widest md:!mb-4">Data Persistence</span>
                        <h1 ref={heroTitleRef} className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-[#2A2A2A] !mb-2 md:mb-6 leading-tight break-words">
                            Data Analytics & <br />
                            <span className="text-[#2197A1]">Campaign Intelligence</span>
                        </h1>
                        <div className="space-y-4 max-w-3xl !mb-0 md:!mb-8">
                            <p ref={heroParaMobileRef} className="block md:hidden text-sm sm:text-base text-[#2A2A2A]/80 font-medium leading-snug text-center">
                                We turn complex data sets into clear, actionable roadmaps that empower your business with predictive depth.
                            </p>
                            <div className="hidden md:block">
                                <p ref={heroParaDesktopRef} className="text-lg md:text-xl text-[#2A2A2A]/80 font-medium leading-relaxed">
                                    We transform complex datasets into actionable growth strategies. Our advanced
                                    analytics and real-time intelligence reveal market opportunities that others miss.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="lg:hidden w-full flex justify-center items-center !my-0 relative">
                            <HeroVisual3D icons={analyticsIcons} />
                        </div>
            ...
            <section ref={servicesSectionRef} className="relative w-full bg-white !pt-10 md:!py-20 !px-3 md:px-12 lg:px-24 overflow-hidden">
                <div className="relative z-10 max-w-7xl !mx-auto">
                    <div className="text-center !mb-10">
                        <span ref={servicesSubtitleRef} className="text-[#2197A1] font-bold text-sm uppercase tracking-widest mb-4 block">Precision Analytics</span>
                        <h2 ref={servicesTitleRef} className="text-4xl md:text-6xl font-bold text-[#2A2A2A] mb-8">Our Intelligence Services</h2>
                    </div>
            ...
            <section ref={timelineSectionRef} className="relative w-full bg-white !pt-10 md:!py-20 !px-10 md:px-12 lg:px-24 overflow-hidden">
                <div className="max-w-7xl !mx-auto">
                    <div className="text-center !mb-10">
                        <h2 ref={timelineTitleRef} className="text-4xl md:text-6xl font-black text-[#2A2A2A] !mb-4 tracking-tight uppercase">Intelligence TIMELINE</h2>
                        <p ref={timelineParaRef} className="text-gray-400 text-lg max-w-2xl !mx-auto font-medium">
                            How we architect your data ecosystem from strategy to execution.
                        </p>
                    </div>
                ...
                <div className="relative z-10 max-w-7xl !mx-auto flex flex-col lg:flex-row items-center gap-0 md:gap-20">
                    <div className="w-full lg:w-[40%] text-left">
                        ...
                        <h2 ref={techTitleRef} className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-8 leading-tight drop-shadow-lg">
                            Powerful <br />
                            <span className="text-[#e76038]">Intelligence Stack</span>
                        </h2>
                        <p ref={techParaRef} className="text-lg text-white/90 font-medium leading-relaxed mb-10 max-w-lg drop-shadow-md">
                            We use professional analytics tools and industry best practices to build high-performance, data-driven, and scalable insights that deliver real business value.
                        </p>
                        <div ref={techItemsRef} className="flex flex-col gap-5">
                            {["Real-time Data Processing", "AI-Powered Predictions", "Cloud-Native Data Lakes"].map((item, i) => (
