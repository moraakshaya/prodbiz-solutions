        ...
        <main className="flex min-h-screen flex-col items-center">
            ...
            >
                ...
                <div className="z-10 w-full max-w-7xl !mx-auto flex flex-col lg:flex-row items-center !px-4 md:px-6 !pt-3 sm:!pt-15 lg:!pt-10 gap-1 sm:gap-10 lg:gap-5">
                    ...
                    <div className="w-full lg:w-[60%] flex flex-col items-center lg:items-start text-center lg:text-left lg:translate-y-[-20px] pr-0">
                        <span className="hidden md:block text-[#e76038]/80 font-bold text-sm uppercase tracking-widest md:!mb-4">Intelligence at Scale</span>
                        ...
                        <div className="space-y-4 max-w-3xl !mb-0 md:!mb-8">
                            ...
                            <div className="hidden md:block">
                                <p className="text-lg md:text-xl text-[#2A2A2A]/80 font-medium leading-relaxed">
                                    We turn complex data sets into clear, actionable roadmaps. Our team builds
                                    intelligent systems that empower your business with predictive depth and
                                    unparalleled campaign visibility.
                                </p>
                            </div>
                        </div>
            ...
            <section className="relative w-full bg-white !pt-10 md:!py-20 !px-3 md:px-12 lg:px-24 overflow-hidden">
                <div className="relative z-10 max-w-7xl !mx-auto">
                    <div className="text-center !mb-10">
                        <span className="text-[#2197A1] font-bold text-sm uppercase tracking-widest mb-4 block">Precision Analytics</span>
                        <h2 className="text-4xl md:text-6xl font-bold text-[#2A2A2A] mb-8">Our Intelligence Services</h2>
                    </div>
            ...
            <section className="relative w-full bg-white !pt-10 md:!py-20 !px-10 md:px-12 lg:px-24 overflow-hidden">
                <div className="max-w-7xl !mx-auto">
                    <div className="text-center !mb-10">
                        <h2 className="text-4xl md:text-6xl font-black text-[#2A2A2A] !mb-4 tracking-tight uppercase">Intelligence TIMELINE</h2>
                ...
                <div className="relative z-10 max-w-7xl !mx-auto flex flex-col lg:flex-row items-center gap-0 md:gap-20">
                    <div className="w-full lg:w-[40%] text-left">
                        ...
                        <p className="text-lg text-white/90 font-medium leading-relaxed mb-10 max-w-lg drop-shadow-md">
                            We use industrial-strength tools and languages to ensure your data is processed with speed, accuracy, and enterprise-grade security.
                        </p>
                        <div className="flex flex-col gap-5">
                            {["Advanced ML Models", "Cloud Data Warehousing", "Interactive Visualizations"].map((item, i) => (
