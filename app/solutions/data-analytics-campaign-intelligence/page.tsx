        ...
        <main className="flex min-h-screen flex-col items-center">
                ...
                <div className="z-10 w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center px-6">
                    ...
                    <div className="w-full md:w-[70%] !pl-[14%] flex flex-col items-start">
                        ...
                        <p className="text-lg md:text-xl text-[#2A2A2A]/80 font-medium max-w-3xl">
                            ...
                            We leverage advanced analytics and real-time intelligence to optimize
                            your campaigns and predict future market trends.
                        </p>
                    </div>
            ...
            <section className="w-full bg-white py-20 px-6 sm:px-12 lg:px-24">
                <div className="max-w-7xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#2A2A2A] mb-8">Master Your Market Data</h2>
                    <p className="text-lg text-gray-500 max-w-3xl mx-auto">
                        In the age of information, data is the key to competitive advantage.
                        We help you navigate the noise, providing the clarity and intelligence
                        needed to make bold moves and achieve exceptional campaign results.
                    </p>
                </div>
            </section>
