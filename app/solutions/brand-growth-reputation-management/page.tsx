        ...
        <main className="flex min-h-screen flex-col items-center">
                ...
                <div className="z-10 w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center px-6">
                    ...
                    <div className="w-full md:w-[70%] !pl-[14%] flex flex-col items-start">
                        ...
                        <p className="text-lg md:text-xl text-[#2A2A2A]/80 font-medium max-w-3xl">
                            Building trust and scaling your brand's presence in the digital landscape.
                            We protect your image and amplify your reach through strategic positioning,
                            proactive management, and meaningful engagement.
                        </p>
                    </div>
            ...
            <section className="w-full bg-white py-20 px-6 sm:px-12 lg:px-24">
                <div className="max-w-7xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#2A2A2A] mb-8">Shape Your Public Identity</h2>
                    <p className="text-lg text-gray-500 max-w-3xl mx-auto">
                        In a world driven by perception, your reputation is your most valuable asset.
                        We help you build a brand that resonates with integrity and scale it with
                        confidence, ensuring you remain the leader in your industry.
                    </p>
                </div>
            </section>
