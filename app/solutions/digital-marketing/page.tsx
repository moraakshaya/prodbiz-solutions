...
const marketingServicesData = [
    {
        title: "SEO",
        desc: "We improve your website so it appears on Google when people search for your services.",
        icon: <Search size={42} strokeWidth={1.5} />
    },
    {
        title: "Google Ads",
        desc: "We run ads on Google to bring instant traffic and leads to your business.",
        icon: <MousePointerClick size={42} strokeWidth={1.5} />
    },
    {
        title: "Social Media Marketing",
        desc: "We promote your business on platforms like Instagram and Facebook.",
        icon: <Share2 size={42} strokeWidth={1.5} />
    },
    {
        title: "Performance Tracking",
        desc: "We track results and improve campaigns to get better outcomes.",
        icon: <TrendingUp size={42} strokeWidth={1.5} />
    },
    {
        title: "Local Marketing",
        desc: "We help your business reach nearby customers through local search.",
...
const whyChooseUsData = [
    ...
    {
        title: "Simple & effective marketing",
        desc: "We use proven digital marketing strategies to get better results.",
        icon: <Zap size={32} />
    },
    {
        title: "Regular updates & support",
        desc: "We provide campaign updates and ongoing support to improve performance.",
        icon: <Settings size={32} />
    },
    {
        title: "Complete marketing solutions",
        desc: "We offer end-to-end digital marketing services to grow your business online.",
        icon: <Globe size={32} />
    }
];
...
export default function DigitalMarketingPage() {
    ...
    const titleText = "Digital Marketing Services";
    const paraText = "We promote your business online to help you reach more people and get more customers.";
    const smallLineText = "From SEO to ads and social media, we handle everything to grow your business online.";
    ...
    return (
        <main className="flex min-h-screen flex-col items-center">
            ...
            <section ref={introSectionRef} className="w-full bg-white !py-4 md:!py-24 !px-6 overflow-hidden">
                <div className="max-w-7xl !mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20">
                    ...
                    <div ref={introContentRef} className="w-full md:w-1/2 space-y-6 text-left">
                        <span className="text-[#2197A1] font-black uppercase tracking-widest text-xs !mb-3 block">Digital Dominance</span>
                        <h2 className="text-4xl md:text-5xl font-bold text-[#2A2A2A] !mb-3 leading-tight">
                            Why Digital Marketing <br /><span className="text-[#2197A1]">is Important</span>
                        </h2>
                        ...
                        <div className="space-y-6 text-lg md:text-xl text-[#2A2A2A]/70 leading-relaxed font-medium">
                            <p>
                                Today, most customers search on <span className="font-bold">Google and social media</span> before choosing a business, so having a <span className="font-bold">strong online presence</span> is very important. <span className="font-bold">Digital marketing</span> helps your business <span className="font-bold">appear in front of the right people</span> at the right time, making it easier to <span className="font-bold">attract potential customers</span> and <span className="font-bold">grow your brand</span>.
                            </p>
                            <p>
                                At <span className="font-bold">Prodbiz Solutions</span>, we use <span className="font-bold">simple and effective digital marketing strategies</span> like <span className="font-bold">SEO, social media marketing, and online advertising</span> to <span className="font-bold">increase your visibility</span>, bring <span className="font-bold">more website traffic</span>, and help you <span className="font-bold">get real customers</span>. Our goal is to make your business <span className="font-bold">easy to find online</span> and support your growth with <span className="font-bold">result-driven marketing</span>.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            {/* What We Do for Your Business - Premium 3D Pedestal Version */}
            <section ref={offerSectionRef} className="relative w-full bg-white !pt-15 md:!pt-20 !px-0 overflow-hidden">
                ...
                <div className="relative z-10 !mx-auto">
                    <div ref={offerHeaderRef} className="text-center !mb-1 md:!mb-24">
                        <span className="text-[#2197A1] font-black uppercase tracking-widest text-xs !mb-1 md:!mb-3 block">Expert Marketing</span>
                        <h2 className="text-4xl md:text-5xl font-black !text-[#1E293B] !mb-2 md:!mb-4 leading-tight tracking-tighter">
                            What We Do for <span className="text-[#2197A1]">Your Business</span>
                        </h2>
                    ...
                    <div ref={mobileOfferCardsRef}>
                        <MobileServiceCarousel items={marketingServicesData} />
                    </div>
                </div>
                ...
                <div className="max-w-7xl !mx-auto !px-6">
                    <div ref={portfolioHeaderRef} className="text-center !mb-16 md:!mb-0">
                        ...
                        <h2 className="text-4xl md:text-6xl font-black text-[#2A2A2A] !mb-2 md:!mb-6 leading-tight">
                            Our <span className="text-[#2197A1]">Marketing Work</span>
                        </h2>
