...
function createTextTexture(gl: any, text: string, font = '500 32px Figtree', color = 'black') {
...
class Title {
  ...
  constructor({ gl, plane, renderer, text, textColor = '#545050', font = '500 32px Figtree' }: any) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
