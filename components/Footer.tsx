...
const socialLinks = [
    {
        label: "LinkedIn",
        href: "https://in.linkedin.com/company/prodbiz-solutions-pvt-ltd",
        icon: (
    ...
    {
        label: "Instagram",
        href: "https://www.instagram.com/prodbizsolutions/",
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
    ...
    {
        label: "Facebook",
        href: "https://www.facebook.com/prodbizsolutions",
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
    ...
    {
        label: "Twitter",
        href: "https://x.com/ProdbizOfficial",
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
    ...
    {
        label: "YouTube",
        href: "https://www.youtube.com/@Prodbiz_Solutions",
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
                    ...
                    <div className="footer__col">
                        ...
                        <ul className="footer__contact">
                            ...
                            <li>
                                ...
                                <span>Flat No:101, 1st Floor, Sri Ikon Residency, Plot No 496, Near Miyapur, Mathrusree Nagar, Hyderabad, Telangana – 500049.</span>
                            </li>
                            <li>
