...
const LogoTile = ({ client }: { client: (typeof clients)[0] }) => (
    <div
        className="group flex-shrink-0 flex items-center justify-center bg-white border border-gray-100 rounded-2xl px-8 py-5 mx-3 shadow-[0_6px_20px_rgba(0,0,0,0.05)] hover:shadow-[0_16px_40px_rgba(33,151,161,0.12)] hover:-translate-y-1.5 transition-all duration-300 cursor-default select-none"
        style={{ minWidth: "170px", height: "90px" }}
        title={client.name}
    >
        ...
        <img
            src={client.src}
            alt={client.name}
            className="max-h-12 max-w-[120px] object-contain grayscale group-hover:grayscale-0 opacity-60 group-hover:opacity-100 transition-all duration-300 drop-shadow-[0_4px_8px_rgba(0,0,0,0.1)] group-hover:drop-shadow-[0_6px_14px_rgba(0,0,0,0.15)]"
            onError={(e) => {
...
const ClientsSection = () => {
    ...
    return (
        <section className="relative w-full !pt-10 !pb-20 overflow-hidden bg-white">
            {/* Subtle dot grid */}
            ...
            <div className="relative">
                ...
                <div className="relative !mt-5">
                    ...
                    <div className="flex overflow-hidden py-4">
                        <div
                            className="flex animate-[marquee_35s_linear_infinite] hover:[animation-play-state:paused] gap-4"
